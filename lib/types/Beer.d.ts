...
export type BeerStatus = 'on-tap' | 'seasonal' | 'coming-soon' | 'limited-edition' | 'sold-out' | 'archived' | 'retired';
export type BeerAvailability = 'Year-round' | 'Spring' | 'Summer' | 'Fall' | 'Winter' | 'Limited' | 'Seasonal';
