...
export const AdminBeerCreatePage: React.FC = () => {
  ...
  const loadMetadata = async () => {
    ...
    try {
      ...
      // Extract statuses from pre-processed beer data
      const statusesSet = new Set<string>();
      beers.forEach((beer: any) => {
        if (beer.status) {
          statusesSet.add(beer.status);
        }
      });
...
${formData.content}`;
      ...
      setError('Failed to create beer');
        ...
        <div className={styles.section}>
          ...
          <div className={styles.formGroup}>
            ...
            <textarea
              ...
              rows={15}
              placeholder={`# ${formData.name || 'Beer Name'}
...
export default AdminBeerCreatePage;
