---
style_code: "15C"
style_name: "Irish Extra Stout"
category: "15"
category_name: "Irish Beer"
bjcp_2021: true
tags: ["lager","light-strength","high-strength","dark-color","top-fermented","british-isles","traditional-style","stout-family","bitter","roasty","BJCP","Beer","Style","Guidelines","–","2021","Edition","16.","#","DARK","BRITISH","BEER!","This","category","contains","average","to","strong","sweet","modern","British","and","Irish","stouts","that","originated","in","England","even","if","some","are","now","more","widely","associated","with","Ireland.","In","this","case","“British”","means","the","broader","Isles","not","Great","Britain.","29"]
---
...
Midway between an Irish Stout and a Foreign Extra Stout in strength and flavor intensity, although with a similar balance. More body, richness, and often malt complexity than an Irish Stout. Black in color, not brown like an English Porter. Vital Statistics: OG: 1.052 – 1.062 IBUs: 35 – 50 FG: 1.010 – 1.014 SRM: 30 – 40 ABV: 5.0 – 6.5% Commercial Examples: Guinness Extra Stout, O’Hara’s Leann Folláin, Porterhouse XXXX, Sheaf Stout Tags: high-strength, dark-color, top-fermented, british-isles, traditional-style, stout-family, bitter, roasty BJCP Beer Style Guidelines – 2021 Edition 16. # DARK BRITISH BEER! This category contains average to strong, bitter to sweet, modern British and Irish stouts that originated in England even if some are now more widely associated with Ireland. In this case, “British” means the broader British Isles not Great Britain. BJCP Beer Style Guidelines – 2021 Edition 29

## Vital Statistics

OG: 1.052 – 1.062 IBUs: 35 – 50 FG: 1.010 – 1.014 SRM: 30 – 40 ABV: 5.0 – 6.5%
...
*lager, light-strength, high-strength, dark-color, top-fermented, british-isles, traditional-style, stout-family, bitter, roasty, BJCP, Beer, Style, Guidelines, –, 2021, Edition, 16., #, DARK, BRITISH, BEER!, This, category, contains, average, to, strong, sweet, modern, British, and, Irish, stouts, that, originated, in, England, even, if, some, are, now, more, widely, associated, with, Ireland., In, this, case, “British”, means, the, broader, Isles, not, Great, Britain., 29*
