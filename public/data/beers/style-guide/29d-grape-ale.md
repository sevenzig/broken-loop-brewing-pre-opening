---
style_code: "29D"
style_name: "Grape Ale"
category: "29"
category_name: "Fruit Beer"
bjcp_2021: true
tags: ["fruit-beer","specialty-beer","fruit","BJCP","Beer","Style","Guidelines","–","2021","Edition","67","30.","#","SPICED","BEER!","We","use","the","common","or","culinary","definitions","of","spices","herbs","and","vegetables","not","botanical","scientific","ones.","In","general","are","dried","seeds","seed","pods","roots","bark","etc.","plants","used","for","flavoring","food.","Herbs","leafy","parts","(leaves","flowers","petals","stalks)","Vegetables","savory","less","sweet","edible","plant","products","primarily","cooking","sometimes","eating","raw.","can","include","some","fruit.","This","category","explicitly","includes","all","as","well","nuts","(or","anything","with","‘nut’","in","name","including","coconut)","chile","peppers","coffee","chocolate","spruce","tips","rose","hips","hibiscus","peels/zest","(but","juice)","rhubarb","like.","It","does","grains.","Flavorful","fermentable","sugars","syrups","(e.g.","agave","nectar","maple","syrup","molasses","sorghum","treacle","honey)","sweeteners","lactose)","be","included","only","combination","other","allowable","ingredients","should","have","a","dominant","character.","Any","may","also","entered.","See","Category","29","definition","examples","Introduction","to","Specialty-Type","section","additional","comments","particularly","on","evaluating","balance","added","base","beer."]
---
...
Medium-high to high carbonation improves the perception of aroma. Body is generally from low to medium BJCP Beer Style Guidelines – 2021 Edition and some acidity can contribute to increased perception of dryness. Finish is exceedingly dry and crisp. Strong examples may show some warming.
...
OG: 1.059 – 1.075 IBUs: 10 – 30 FG: 1.004 – 1.013 SRM: 4 – 8 ABV: 6.0 – 8.5%
...
*fruit-beer, specialty-beer, fruit, BJCP, Beer, Style, Guidelines, –, 2021, Edition, 67, 30., #, SPICED, BEER!, We, use, the, common, or, culinary, definitions, of, spices, herbs, and, vegetables, not, botanical, scientific, ones., In, general, are, dried, seeds, seed, pods, roots, bark, etc., plants, used, for, flavoring, food., Herbs, leafy, parts, (leaves, flowers, petals, stalks), Vegetables, savory, less, sweet, edible, plant, products, primarily, cooking, sometimes, eating, raw., can, include, some, fruit., This, category, explicitly, includes, all, as, well, nuts, (or, anything, with, ‘nut’, in, name, including, coconut), chile, peppers, coffee, chocolate, spruce, tips, rose, hips, hibiscus, peels/zest, (but, juice), rhubarb, like., It, does, grains., Flavorful, fermentable, sugars, syrups, (e.g., agave, nectar, maple, syrup, molasses, sorghum, treacle, honey), sweeteners, lactose), be, included, only, combination, other, allowable, ingredients, should, have, a, dominant, character., Any, may, also, entered., See, Category, 29, definition, examples, Introduction, to, Specialty-Type, section, additional, comments, particularly, on, evaluating, balance, added, base, beer.*
